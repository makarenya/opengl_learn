...
private:
    ...
    TMaterial Asphalt{TMaterialBuilder()
                          .SetColor("specular_col", glm::vec4(0.1f, 0.1f, 0.1f, 1.0f))
                          .SetTexture("diffuse_map", TTextureBuilder().SetFile("images/asphalt_diffuse.png").SetMipmap(ETextureMipmap::Linear))
                          .SetConstant("shiness", 5)};
    TMaterial Container{TMaterialBuilder()
